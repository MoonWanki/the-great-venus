...
class GameBase extends Component {
    ...
    loadResources = () => {
        ...
        .add("statue0", require("../images/statue/0/default.png"))
        .add("statue1", require("../images/statue/1/default.png"))
        .add("statue2", require("../images/statue/2/default.png"))
        .add("statue3", require("../images/statue/3/default.png"))
