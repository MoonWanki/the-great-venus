...
class GameBase extends Component {
    ...
    loadResources = () => {
        ...
        .add("banner", require("../images/banner.png"))
        ...
        .add("btn", require("../images/ui/btn.png"))
        .add("btn_hover", require("../images/ui/btn_hover.png"))
        .add("btn_long", require("../images/ui/btn_long.png"))
        .add("btn_long_hover", require("../images/ui/btn_long_hover.png"))
        .add("modal", require("../images/ui/modal.png"))
        .add("btn_start", require("../images/ui/btn_start.png"))
        .add("btn_start_hover", require("../images/ui/btn_start_hover.png"))
        .add("statue_spec_view", require("../images/ui/statue_spec_view.png"))
        .add("profile_container", require("../images/ui/profile_container.png"))
        .add("btn_stageselect_disabled", require("../images/ui/btn_stageselect/disabled.svg"))
        .add("btn_stageselect_1", require("../images/ui/btn_stageselect/1.svg"))
        .add("btn_stageselect_1_hover", require("../images/ui/btn_stageselect/1_hover.svg"))
        .add("btn_stageselect_2", require("../images/ui/btn_stageselect/2.svg"))
        .add("btn_stageselect_2_hover", require("../images/ui/btn_stageselect/2_hover.svg"))
        .add("equip_display_container", require("../images/ui/equip_display_container.png"))
        .add("icon_eth", require("../images/ui/icon_eth.svg"))
        .add("icon_sorbiote", require("../images/ui/icon_sorbiote.png"))
        .add("icon_equip_none", require("../images/ui/icon_equip/none.png"))
        .add("icon_equip_hp1", require("../images/ui/icon_equip/fedora.png"))
        .add("icon_equip_hp2", require("../images/ui/icon_equip/ribbon.png"))
        .add("icon_equip_hp3", require("../images/ui/icon_equip/snapback.png"))
        .add("icon_equip_atk1", require("../images/ui/icon_equip/emerald.png"))
        .add("icon_equip_atk2", require("../images/ui/icon_equip/ruby.png"))
        .add("icon_equip_atk3", require("../images/ui/icon_equip/sapphire.png"))
        .add("icon_equip_def1", require("../images/ui/icon_equip/chain.png"))
        .add("icon_equip_def2", require("../images/ui/icon_equip/heart.png"))
        .add("icon_equip_def3", require("../images/ui/icon_equip/moon.png"))
        .add("underlight", require("../images/ui/underlight.png"))
        .add("trophy_diamond", require("../images/ui/colosseum/trophy_diamond.png"))
        .add("trophy_platinum", require("../images/ui/colosseum/trophy_platinum.png"))
        .add("trophy_gold", require("../images/ui/colosseum/trophy_gold.png"))
        .add("trophy_silver", require("../images/ui/colosseum/trophy_silver.png"))
        .add("trophy_bronze", require("../images/ui/colosseum/trophy_bronze.png"))
        .add("icon_info", require("../images/ui/colosseum/icon_info.png"))
        .add("icon_info_hover", require("../images/ui/colosseum/icon_info_hover.png"))
        .add("icon_match", require("../images/ui/colosseum/icon_match.png"))
        .add("icon_match_hover", require("../images/ui/colosseum/icon_match_hover.png"))
        .add("reward_display_title", require("../images/ui/colosseum/reward_display_title.png"))
        .add("reward_display_board", require("../images/ui/colosseum/reward_display_board.png"))
        ...
        .add("mob2", require("../images/mob/giant_rabbit.svg"))
        .add("mob3", require("../images/mob/mushroom1.svg"))
        .add("mob4", require("../images/mob/mushroom2.svg"))
        .add("mob5", require("../images/mob/stump1.svg"))
        .add("mob6", require("../images/mob/mushroom3.svg"))
        .add("mob7", require("../images/mob/mushroom4.svg"))
        .add("mob8", require("../images/mob/cactus1.svg"))
        .add("mob9", require("../images/mob/cactus2.svg"))
        .add("mob10", require("../images/mob/fox1.svg"))
        .add("mob11", require("../images/mob/fox2.svg"))
        ...
        .add("bg_main2_sky", require("../images/background/main/2/sky.png"))
        ...
        .add("bg_main3_sky", require("../images/background/main/3/sky.png"))
        ...
        .add("bg_main4_sky", require("../images/background/main/4/sky.png"))
        ...
        .add("bg_colosseum_field", require("../images/background/colosseum/field/1.png"))
        ...
        .add("bg_field4_1_1", require("../images/background/field/4/1/1.png"))
        .add("bg_field4_1_2", require("../images/background/field/4/1/2.png"))
        .add("bg_field4_1_3", require("../images/background/field/4/1/3.png"))
        .add("bg_field4_1_4", require("../images/background/field/4/1/4.png"))
        .add("bg_field4_1_5", require("../images/background/field/4/1/5.png"))
        .add("bg_field4_1_6", require("../images/background/field/4/1/6.png"))
        .add("bg_field4_2_1", require("../images/background/field/4/2/1.png"))
        .add("bg_field4_2_2", require("../images/background/field/4/2/2.png"))
        .add("bg_field4_2_3", require("../images/background/field/4/2/3.png"))
        .add("bg_field4_2_4", require("../images/background/field/4/2/4.png"))
        .add("bg_field4_2_5", require("../images/background/field/4/2/5.png"))
        .add("bg_field4_2_6", require("../images/background/field/4/2/6.png"))
        .add("bg_field4_3_1", require("../images/background/field/4/3/1.png"))
        .add("bg_field4_3_2", require("../images/background/field/4/3/2.png"))
        .add("bg_field4_3_3", require("../images/background/field/4/3/3.png"))
        .add("bg_field4_3_4", require("../images/background/field/4/3/4.png"))
        .add("bg_field4_3_5", require("../images/background/field/4/3/5.png"))
        .add("bg_field4_3_6", require("../images/background/field/4/3/6.png"))
        ...
        .add("bg_stageselect2_1", require("../images/background/stageselect/2/1.png"))
        .add("bg_stageselect2_2", require("../images/background/stageselect/2/2.png"))
        .on('progress', (loader) => {
